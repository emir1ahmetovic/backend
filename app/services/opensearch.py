...
def _get_client():
    ...
    # Basic, unauthenticated client. In production you will likely want
    # SigV4 or basic auth + TLS configuration.
...
def index_document_embedding(
    ...
    try:
        ...
        # Fail silently for now; production code should log this.
        return None
